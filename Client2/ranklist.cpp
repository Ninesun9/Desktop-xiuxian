...
void RankList::on_pushButton_1_clicked()
{
    ...
    accessManager->get(QNetworkRequest(QUrl("http://yinciyunji.com:8522/rank/xiuwei")));
...
{
    accessManager->get(QNetworkRequest(QUrl("http://yinciyunji.com:8522/rank/shengming")));
}


void RankList::on_pushButton_3_clicked()
{
    accessManager->get(QNetworkRequest(QUrl("http://yinciyunji.com:8522/rank/gongji")));
}


void RankList::on_pushButton_4_clicked()
{
    accessManager->get(QNetworkRequest(QUrl("http://yinciyunji.com:8522/rank/fangyu")));
}
...
{
    accessManager->get(QNetworkRequest(QUrl("http://yinciyunji.com:8522/rank/jifen")));
